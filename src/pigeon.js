        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    ...
                    _d = [void 0, "".concat(new Date().getMonth() + 1, "\uC6D4 ").concat(new Date().getDate(), "\uC77C \uC885\uD569 \uB274\uC2A4 (").concat(new Date().getHours(), "\uC2DC ").concat(new Date().getMinutes(), "\uBD84)")];
                    return [4 /*yield*/, getNews()];
                case 4:
                    message = new (_c.apply(_b, _d.concat([_e.sent(), trainee.getTraineeMgrSeq()])))();
